...
public class TG_2AFC_WitReference_ASAP : TrialGeneratorASAP
{
    protected bool swapped;

    public TG_2AFC_WitReference_ASAP(Dataset dataset) : base(dataset)
    {
    ...
    public override void KeyboardInput()
    {
        if (Input.GetKeyDown(KeyCode.LeftArrow))
        {
            ...
            {
                Debug.Log("isNextTrialAvailable = false, go to next scene");
                NextScene();
            }
        }
